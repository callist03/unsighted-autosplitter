...
init
{
	...
	vars.loadedSlot = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll", 0x015465D0,0x30,0x10,0x540,0x30));
	vars.loadedSlot.Update(game);

	vars.loadingData = new MemoryWatcherList
	{
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll", 0x151F5C0,0x0,0x10,0x38,0x38,0x20,0x0,0x1A0)){Name="cutscene"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll", 0x153FAB8,0x0,0x10,0x590,0x18,0x18)){Name="popupCount"}
	};
	vars.startingData = new MemoryWatcherList
	{
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x0153FF88 ,0x0, 0x10, 0x4F0,0x20)){Name="refillPlayerLife"},
		new MemoryWatcher<int>(new DeepPointer("mono-2.0-bdwgc.dll",0x00490A68,0x10,0x2C8,0x448,0x8,0x30,0x20,0x40)){Name="beganLoadingGame"}
	};
	vars.beganLoadingGameZero = false;

	vars.playerData = new MemoryWatcherList
	{
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0xF0)){Name="timeOfDayPasses"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0xF4)){Name="chipSlots"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0xF8)){Name="museumLightsOn"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0xF9)){Name="lavaOn"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x108)){Name="totalDeaths"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x10C)){Name="parryChallengeRecord"},
		//0 = Medium, 1 = Easy, 2 = Hard
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x110)){Name="difficulty"},
		//0 = Regular, 1 = NGPlus, 2 = NGExtra
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x114)){Name="gameMode"},
		//0 = MainStory, 1 = Dungeon, 2 = BossRush
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x118)){Name="gameType"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x11C)){Name="invencibilityAssist"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x11D)){Name="staminaAssist"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x11E)){Name="timeAssist"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x11F)){Name="combatAssist"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x120)){Name="currentDungeonRoom"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x124)){Name="currentDungeonArea"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x128)){Name="bossRushProgress"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x12C)){Name="permaDeath"},
		new MemoryWatcher<bool>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x12D)){Name="equipItemsAutomatically"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x130)){Name="numberOfPerfectCatches"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x134)){Name="numberOfTreasureDig"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x138)){Name="numberOfRareTreasuresDig"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x13C)){Name="amountGivenToGrimReaper"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x140)){Name="meteorDustBought"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x144)){Name="keyBought"},
		new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x148)){Name="previousFileNumberNGPlus"}
	};

	vars.wasLoading = false;

	vars.dataStrings = new List<string>();
	vars.dataStringsSize = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x78,0x18));
	vars.dataStringsSize.Update(game);

	for(int i = 0; i < vars.dataStringsSize.Current; i++)
	{
		IntPtr ptr = IntPtr.Zero;
		var dataStringLength = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x78,0x10,(0x8*i)+0x20,0x10));
		dataStringLength.Update(game);
		new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x78,0x10,(0x8*i)+0x20,0x14).DerefOffsets(game, out ptr);
	...
	vars.playerWeaponsSize = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x28,0x18));
	vars.playerWeaponsSize.Update(game);

	for(int i = 0; i < vars.playerWeaponsSize.Current; i++)
	{
		IntPtr ptr = IntPtr.Zero;
		var itemNameLength = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x28,0x10,(0x8*i)+0x20,0x10,0x10));
		itemNameLength.Update(game);
		new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x28,0x10,(0x8*i)+0x20,0x10,0x14).DerefOffsets(game, out ptr);
	...
	vars.playerArmorsSize = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x30,0x18));
	vars.playerArmorsSize.Update(game);

	for(int i = 0; i < vars.playerArmorsSize.Current; i++)
	{
		IntPtr ptr = IntPtr.Zero;
		var itemNameLength = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x30,0x10,(0x8*i)+0x20,0x10,0x10));
		itemNameLength.Update(game);
		new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x30,0x10,(0x8*i)+0x20,0x10,0x14).DerefOffsets(game, out ptr);
		var itemName = memory.ReadString(ptr, 2*itemNameLength.Current);
		vars.playerItems.Add(itemName);
	}

	vars.playerItemsSize = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x38,0x18));
	vars.playerItemsSize.Update(game);

	for(int i = 0; i < vars.playerItemsSize.Current; i++)
	{
		IntPtr ptr = IntPtr.Zero;
		var itemNameLength = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x38,0x10,(0x8*i)+0x20,0x10,0x10));
		itemNameLength.Update(game);
		new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x38,0x10,(0x8*i)+0x20,0x10,0x14).DerefOffsets(game, out ptr);
		var itemName = memory.ReadString(ptr, 2*itemNameLength.Current);
		vars.playerItems.Add(itemName);
	}

	vars.playerChipsSize = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x50,0x18));
	vars.playerChipsSize.Update(game);

	for(int i = 0; i < vars.playerChipsSize.Current; i++)
	{
		IntPtr ptr = IntPtr.Zero;
		var itemNameLength = new MemoryWatcher<int>(new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x50,0x10,(0x8*i)+0x20,0x10,0x10));
		itemNameLength.Update(game);
		new DeepPointer("UnityPlayer.dll",0x015465D0,0x30,0x10,0x540,0x18,0x20,0x10,(8*vars.loadedSlot.Current)+32,0x50,0x10,(0x8*i)+0x20,0x10,0x14).DerefOffsets(game, out ptr);
		var itemName = memory.ReadString(ptr, 2*itemNameLength.Current);
		vars.playerItems.Add(itemName);
	}
...
update
{
	...
	vars.loadingData.UpdateAll(game);
	
}
isLoading
{
	return (vars.loadingData["cutscene"].Current && (vars.loadingData["popupCount"].Current == 0));
}
start
{
	vars.loadingData.UpdateAll(game);
	vars.startingData.UpdateAll(game);
	if(vars.startingData["beganLoadingGame"].Current == 0)
	{
		vars.beganLoadingGameZero = true;
	}
	if(vars.loadingData["cutscene"].Current && (vars.loadingData["popupCount"].Current == 0))
	{
		vars.wasLoading = true;
	}
	if(!(vars.loadingData["cutscene"].Current && (vars.loadingData["popupCount"].Current == 0)) && vars.beganLoadingGameZero && (vars.startingData["beganLoadingGame"].Current != 0) && vars.wasLoading)
	{	
		vars.wasLoading = false;
		vars.beganLoadingGameZero = false;
		vars.loadedSlot.Update(game);
